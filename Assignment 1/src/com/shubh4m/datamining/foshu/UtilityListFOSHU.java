...
.	 * @param y the utility-list of pU{Y}.
	 ...
	 * @param pXElements : the utility list of pX
	 * @param pYElements : the utility list of pY
	 */
	 ...
	 * @param pXElements : the utility list of item {x}
	 * @param pYElements : the utility list of item {y}
	 */
	 ...
	 */
	double getSumIRUtilsInPeriod(int period) {
	 ...
	 */
	boolean appearsInPeriod(int period) {
